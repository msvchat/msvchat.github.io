...
OutputDir=E:\output
OutputBaseFilename=Microsoft V-Chat 2.0 Suite Setup(for XP)
...
Source: "E:\source\V-Chat\doc\sdk.rtf"; DestDir: "{app}"; Flags: ignoreversion
;V-Chat System Files
...
Name: "{userdesktop}\Microsoft V-Chat SDK documentation"; Filename: "{app}\sdk.rtf"; Tasks: desktopicon
Name: "{group}\Microsoft V-Chat SDK documentation"; Filename: "{app}\sdk.rtf"; WorkingDir: "{app}"
